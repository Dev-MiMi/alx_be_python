...
match level:
    case "high":
        if time == "yes":
            print(f"Reminder: '{task_des}' is a high priority task that requires immediate attention today!")
        elif time == "no":
    ...
    case "low":
        if time == "yes":
            print(f"Reminder: '{task_des}' is a low priority task that requires immediate attention today!")
        elif time == "no":
            print(f"Note: '{task_des}' is a low priority task. Consider completing it when you have free time.")
